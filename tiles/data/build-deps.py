...
# list_apps = sh.awk(sh.dpkg('-l'), '{print $2}')
#
# install_dependencies = [dep for dep in SYSTEM_DEPENDENCIES if dep not in list_apps]
# print("Must install {}".format(install_dependencies))
